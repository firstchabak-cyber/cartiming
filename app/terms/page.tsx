      ...
      <div className="mt-6 flex flex-col gap-6">
          ...
          <ol className="list-decimal space-y-1 pl-5">
            <li>회사는 회원에게 다음의 서비스를 제공합니다:
              <ul className="mt-1 list-disc space-y-0.5 pl-5">
                ...
                <li>
                  자동 매각 감시(매월 자동 분석)·인앱·이메일 매각 알림 (최초
                  활성화 시 캐시 차감, 이후 추가 차감 없음)
                </li>
        ...
        <Section title="제6조 (캐시 충전, 사용, 환불)">
          <ol className="list-decimal space-y-1 pl-5">
            ...
            <li>
              <strong>환불 요청 방법:</strong> 고객센터 이메일(help@cartiming.app)
              또는 마이페이지 문의를 통해 가입 이메일과 결제(주문) 내역을 알려주시면,
              영업일 3일 이내에 결제하신 수단으로 취소·환불해 드립니다. 환불 가능
              금액(미사용 충전 캐시)은 위 기준에 따릅니다.
            </li>
          </ol>
        </Section>
        ...
        <Section title="제6조의3 (미성년자의 결제)">
          <ol className="list-decimal space-y-1 pl-5">
            <li>
              미성년 회원이 법정대리인의 동의 없이 캐시를 충전·결제한 경우, 본인
              또는 법정대리인은 해당 결제를 취소할 수 있습니다.
            </li>
            <li>
              다만 미성년자가 법정대리인이 처분을 허락한 재산으로 결제하였거나,
              속임수로써 성년자로 믿게 한 경우 등 관련 법령상 취소가 제한되는
              경우에는 그러하지 아니합니다.
            </li>
          </ol>
        </Section>
